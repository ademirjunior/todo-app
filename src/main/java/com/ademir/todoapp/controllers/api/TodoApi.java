...
public interface TodoApi {
    ...
    ResponseEntity<TodoDto> createTodo(@ApiParam(value = "Todo DTO", required = true) @RequestBody TodoDto todoDto);
    ...
    ResponseEntity<TodoDto> updateTodo(@ApiParam(value = "Todo DTO", required = true) @RequestBody TodoDto user);
    ...
    ResponseEntity<TodoDto> getTodo(@ApiParam(value = "The Todo id", required = true) @PathParam(value = "todoId") Long todoId
    );
    ...
    ResponseEntity<?> deleteTodo(@ApiParam(value = "The Todo id", required = true) Long id);
}
